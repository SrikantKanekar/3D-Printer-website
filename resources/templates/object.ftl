                    ...
                    <div class="col-lg-6">
                        <div class="details_image">
                            ...
                            <div class="details_image_thumbnails d-flex flex-row align-items-start justify-content-between">
                                <div class="details_image_thumbnail active" data-image="${object.image}"><img
                                            src="${object.image}" alt=""></div>
                                <div class="details_image_thumbnail" data-image="/static/images/3d-image2.jpg"><img
                                            src="/static/images/3d-image2.jpg" alt=""></div>
                                <div class="details_image_thumbnail" data-image="/static/images/3d-image3.jpeg"><img
                                            src="/static/images/3d-image3.jpeg" alt=""></div>
                                <div class="details_image_thumbnail" data-image="/static/images/3d-image4.jpeg"><img
                                            src="/static/images/3d-image4.jpeg" alt=""></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="details_content">
                            ...
                            <div class="product_quantity_container">
                                <div class="product_quantity clearfix">
                                    <span>Qty</span>
                                    <input id="quantity_input" type="number" value="${object.quantity}">
                            ...
                            <div class="cart_remove_button_container">
                                <div class="button cart_remove_button"><a href="/object/remove-from-cart">Remove from
                                        cart</a></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item setting_title">
                                <a class="active" id="basic-tab" data-toggle="tab" href="#basic" role="tab"
                                   aria-controls="basic" aria-selected="true">Basic Setting</a>
                            </li>
                            <li class="nav-item setting_title">
                                <a id="advanced-tab" data-toggle="tab" href="#advanced" role="tab"
                                   aria-controls="advanced" aria-selected="true">Advanced Setting</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content setting_content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="basic" role="tabpanel"
                                ...
                                <div class="setting_form_container">
                                    <form class="form" action="/object/${object.id}/basic" method="POST"
                                          id="basic_settings_form">

                                        <label for="size">Size</label>
                                        <div data-validate="Please enter size">
                                            <input type="number" name="size"
                                                   value="${object.basicSettings.size?string.computer}" id="size"
                                                   class="input" required="required"/>
                                        </div>

                                        <div class="form_message"></div>
                                        <div id="basic_button" class="button form_submit_button"><a href="#">Update</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="advanced" role="tabpanel" aria-labelledby="advanced-tab">
                                <div class="setting_form_container">
                                    <form class="form" action="/object/${object.id}/advanced" method="post"
                                          id="advanced_settings_form">

                                        <label for="weight">Weight</label>
                                        <div data-validate="Please enter weight">
                                            <input type="number" name="weight"
                                                   value="${object.advancedSettings.weight?string.computer}" id="weight"
                                                   class="input" required="required"/>
                                        </div>
                                        <div class="form_message"></div>
                                        <div id="advanced_button" class="button form_submit_button"><a
                                                    href="#">Update</a></div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="details_content">
                            ...
                            <div class="details_price"><i class="fa fa-inr"></i>${object.price}</div>
                            <div class="details_status">Printing status : ${object.printingStatus}</div>
                            <div class="details_completed_by">Completed
